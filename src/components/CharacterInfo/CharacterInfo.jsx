...
console.log(character);
  const statusInfo2 = () => {
    if (character.status == "Dead") {
      ...
      return (
        <span className="status2" style={{ backgroundColor: "grey", padding:"5px 110px"}}>
          {character.status}
        </span>
      );
    }
    ...
    <Offcanvas hideCartHandler={hideCharacterInfoHandler}>
      <div className="character-info-container">
        <div className="character-info-head">
          ...
          <a href="/" className="cart-close" onClick={(e) => { e.preventDefault(); hideCharacterInfoHandler() }}>
            x
          </a>
        </div>
        ...
        <div className="character-info">
          ...
          <ul>
            ...
            <li><b>Last Location:</b> {character.location.name}</li>
